...
<style>
    ...
    .pdf-like-content p, .pdf-like-content li {
...
<div class="bg-white mt-3 pdf-like-content">
    <div class="m-2 p-2">
        ...
        <p>The research journals published under TerraVeritas Publishing are English-language, peer-reviewed scholarly journals issued either biannually or quarterly. Each journal follows a consistent publication cycle, with issues released in the first month of each half-year or quarter, depending on its frequency. This schedule ensures the timely dissemination of high-quality research to the global academic community.</p>

        <h2 id="manuscript-submission">2. Manuscript Submission</h2>
        <h3>Types of Papers/Articles</h3>
        <p><strong>Original Articles:</strong> Original articles must present scientific results that are essentially new and should be structured according to the guidelines given below.</p>
        <p><strong>Review Papers:</strong> Review papers should be comprehensive, fully referenced expositions of subjects of general interest, including background information and detailed critical analyses of current work in the field and its significance, often with figures and drawings. They should be designed to serve as source materials.</p>
        <p><strong>Perspectives Articles:</strong> Perspectives articles provide a brief perspective on recent developments in relevant fields. Note that these should not be full reviews, which should instead be submitted as Review Papers.</p>
        <p><strong>Methods Papers:</strong> We welcome papers describing new or improved methods. Please note that methods that are highly specialized and useful only for a relatively small group of researchers will not be considered with priority. We aim for papers that are of broader interest. The paper can be presented in a protocol-style or narrative method-style.</p>
        <p><strong>Opinion Papers:</strong> This category allows researchers to present a new synthesis of the field, future projections, or discussions and speculations that go beyond the level of a standard Review Paper. These are opinionated narratives that help the research field forward.</p>
        ...
        <p>The Editor-in Chief and Managing Editor are responsible for ensuring that all manuscripts meet the academic standards fit for publication and are published in a timely fashion. The editors oversee each article's individual progress through the journal's submission system and are responsible for liaising with authors, reviewers, and Editorial office.</p>
        <img src="{{ asset('assets/imgs/editorial-procedure.png') }}" alt="Editorial Procedure" class="img-fluid">

        <h3>Initial Checks</h3>
        <p>All submitted manuscripts received by the Editorial Office are checked by a professional in-house staff to determine whether the manuscripts are properly prepared and follow the ethical policies of the journal. Manuscripts that are not properly prepared are returned to the authors for revision and resubmission. The manuscripts that do not fit the journal's scope or do not meet the standards of the journal or scientifically insignificant are rejected before peer-review by the Managing Editor.</p>

        <h3>Peer Review</h3>
        <p>Once a manuscript passes the initial checks, it is assigned to at least two independent outside experts for peer-review by a Subject Editor. Potential reviewers suggested by the authors may also be considered. However, the reviewers should not have published with any of the authors during the past five years and should not currently work or collaborate with any of the institutions of the authors of the submitted manuscript. Peer review comments are confidential and are only disclosed with the corresponding author keeping the anonymity of the reviewer. If a revision is invited, the corresponding author submits the revised manuscript, and the final decision is taken by the relevant Subject Editor based on the information gained through the peer-review process.</p>

        <h3>Editors and Editorial Staff as Authors</h3>
        <p>Editorial staff/editors shall remove themselves from the decision-making process of their own academic work submitted to the journal. Submissions authored by editorial staff/editors will be assigned to at least two independent outside reviewers by another subject editor who do not have a Conflict of Interest with the author and similarly the decision shall be made by the same subject editor. In such cases, the review process must be made as transparent and rigorous as possible. Every effort shall be made to minimize any bias in the review process by having another subject editor handle the peer review procedure independently. Further, it is suggested that the subject editor send the article out for review without any author names and affiliations on it.</p>

        <h3>Editorial Decision</h3>
        <p>The Subject Editor will communicate the decision, which will be one of the following:</p>
        <ul>
            <li><em><strong>Accept after Minor Revisions:</strong></em> The paper is in principle accepted after revision based on the reviewer's comments. Authors are given 7 days for minor revisions.</li>
            <li><em><strong>Reconsider after Major Revisions:</strong></em> The acceptance of the manuscript would depend on the revisions. The author needs to provide a point-by-point response of the reviewer's comments. Usually, only one round of major revisions is allowed. Authors are asked to resubmit the revised paper within a suitable time frame, and the revised version is returned to the reviewer for further comments.</li>
            <li><em><strong>Reject:</strong></em> The article has serious flaws, and/or makes no significant contribution. No offer of resubmission to the journal is provided.</li>
        </ul>

        <h3>Manuscript withdrawal</h3>
        <p>It is possible that authors may wish to withdraw their manuscript after submission to the journal. Possible reasons could include major technical error, or the desire to submit the results to a different journal. In all such cases, manuscripts can of course be withdrawn at the author's discretion.</p>

        <h3>Author Appeals</h3>
        <p>Authors may appeal a rejection by sending an e-mail to the Editorial Office of the journal. The appeal must provide detailed justification, including point-by-point responses to the reviewer's comments. The Managing Editor of the journal will forward the manuscript and related information (including the identities of the referees) to the Editor-in-Chief or Editorial Board member to give an advisory recommendation on the manuscript and may recommend acceptance, further peer-review, or uphold the original rejection decision. A reject decision at this stage is final and cannot be reversed.</p>

        <h3>Production and Publication</h3>
        <p>Once accepted, the manuscript will undergo professional copy-editing, English editing, proofreading by the authors, final corrections, pagination, and publication on the journal website.</p>
        ...
        <ul>
            ...
            <li>Review manuscripts should comprise the front matter, literature review sections and the back matter. It is not necessary to follow the remaining structure.</li>
            <li>Acronyms/Abbreviations/Initialisms should be defined the first time they appear in each of three sections: the abstract; the main text; the first figure or table.</li>
            ...
            <li><strong>Equations:</strong> If you are using Microsoft Word, please use either the Equation Editor or the MathType add-on. Equations should be editable and not appear in image format.</li>
        </ul>

        <h3>Front Matter:</h3>
        <p>These sections should appear in all manuscript types.</p>
        <ul>
            <li><strong>Title:</strong> The title of manuscript should be concise, specific, and relevant. It should identify if the study reports trial data or is a systematic review.</li>
            <li><strong>Author's and Affiliations:</strong> Authors' full names must be provided along with complete address including city, zip code, state/province, and country. At least one author should be designated as the corresponding author with email address.</li>
            <li><strong>Abstract:</strong> The abstract should be about 200 words maximum, in a single paragraph, following the structured abstract style without headings: Background, Methods, Results, Conclusion.</li>
            <li><strong>Keywords:</strong> Five to eight pertinent keywords need to be added after the abstract, specific to the article.</li>
        </ul>

        <h3>Research Manuscript Sections:</h3>
        <ul>
            <li><strong>Introduction:</strong> Should briefly place the study in a broad context and highlight its significance and hypotheses.</li>
            <li><strong>Materials and Methods:</strong> Describe with sufficient detail to allow replication; cite established methods and specify equipment/software.</li>
            <li><strong>Results:</strong> Provide concise, precise description and interpretation of findings.</li>
            <li><strong>Discussion:</strong> Interpret findings in context of existing literature, address limitations, and propose future research directions.</li>
            <li><strong>Conclusions:</strong> Summarize the main conclusions in one or two paragraphs.</li>
        </ul>

        <h3>Back Matter:</h3>
        <ul>
            <li><strong>Acknowledgments:</strong> Acknowledge support not covered by contributions or funding (e.g., technical support).</li>
            <li><strong>Funding:</strong> Disclose all funding sources. State "no external funding" or list funder and grant number.</li>
            <li><strong>Author Contributions:</strong> Use CRediT taxonomy terms (e.g., Conceptualization, Methodology, Writing). Contributions should be clear and concise.</li>
            <li><strong>Conflicts of Interest:</strong> Declare any potential conflicts or state "The authors declare no conflict of interest."</li>
        </ul>

        <h3>Sample Statements</h3>
        <ul>
            <li><strong>Acknowledgement:</strong> The authors acknowledge Higher Education Commission for funding (NRPU-8781) and Dr. M.A. Khan for chemical analysis.</li>
            <li><strong>CRediT author statement:</strong> M.A. Ahsen, S.A. Naqvi, M.J. Jaskani designed and ran experiments; M. Waseem, I.A. Khan, K. Hussnain drafted; K. Mehmood, M.M. Khan finalized the draft.</li>
            ...
            <li><strong>Availability of data and material:</strong> Available upon request from the corresponding author.</li>
            ...
            <li><strong>Consent for publication:</strong> All authors consented to publish this research in journal.</li>
            <li><strong>SDGs addressed:</strong> No poverty, Zero hunger, Good health and well-being, etc.</li>
            <li><strong>Policy referred:</strong> Agricultural, Food, Rural development, Sustainable agriculture, Food security, etc.</li>
        ...
        <ol>
            <li>APA in-text citations consist of the author's last name and publication year, e.g. (Jaskani, 2022). When citing a specific part of a source, also include a page number or range, for example (Jaskani, 2022, p. 72) or (John, 2019, pp. 5–14).</li>
            ...
            <li>If a work has two authors, separate their names with an ampersand (&) in a parenthetical citation or “and” in a narrative citation. If there are three or more authors, only include the first author's last name followed by "et al.", meaning "and others".</li>
            <li>Group authors known by their abbreviations (e.g., FAO) are written in full the first time and are abbreviated in subsequent citations.</li>
            <li>If the author of a source is unknown, try to determine if there is an organization or government responsible for creating the content. If so, include its name in the in-text citation (and reference entry). e.g. (Tesla, 2020), FAO, 2024), (WHO, 2025).</li>
            <li>If a statement is supported by multiple sources, the in-text citations can be combined in one parenthesis. Order the sources alphabetically and separate them with a semicolon. Where citing multiple works from the same author, list the years of publication separated by a comma. e.g. (Fred, 2010; Jude, 2005; Simon, 2012, 2018).</li>
        </ol>
        ...
        <h3>References</h3>
        <ol>
            <li>Although the reference format differs depending on the type of source (e.g., a book, webpage, or video), they’re built from the same four components i.e. author, date, title and source.</li>
            ...
            <li>Works that can be accessed online usually have a URL or DOI (digital object identifier). A DOI is often used for scientific publications and books, while URL is more common for other online publications. Use the following guidelines:</li>
        ...
        <ul>
            <li>Food and Agriculture Organization of the United Nations. (2025, June 10). Global information and early warning system on food and agriculture (GIEWS). FAO. Retrieved October 7, 2025, from https://www.fao.org/giews/en/</li>
            <li>Pakistan Bureau of Statistics. (2025). Agriculture statistics of Pakistan. Government of Pakistan. Retrieved October 7, 2025, from https://www.pbs.gov.pk/content/agriculture-statistics</li>
            <li>United States Department of Agriculture. (2025, September). Crop progress report. USDA. Retrieved October 7, 2025, from https://www.nass.usda.gov/Publications/National_Crop_Progress/</li>
            <li>World Bank. (2025). Agriculture and rural development data. World Bank. Retrieved October 7, 2025, from https://data.worldbank.org/topic/agriculture-and-rural-development</li>
        </ul>
        <h4>YouTube video (platform)</h4>
        <ul>
            <li>CIMMYT. (2025, March 10). Climate-smart wheat farming techniques in South Asia [Video]. YouTube. https://www.youtube.com/watch?v=efgh9101</li>
            <li>Food and Agriculture Organization of the United Nations. (2024, November 12). How digital innovation is transforming agriculture [Video]. YouTube. https://www.youtube.com/watch?v=abcd1234</li>
            <li>United States Department of Agriculture. (2023, August 3). Sustainable farming practices for the future [Video]. YouTube. https://www.youtube.com/watch?v=wxyz5678</li>
            <li>World Bank. (2024, September 22). Empowering smallholder farmers through digital tools [Video]. YouTube. https://www.youtube.com/watch?v=hijk1122</li>
        </ul>
        <h4>Blog post (website)</h4>
        <ul>
            <li>Iqbal, S. (2023, August 18). 5 ways Al is reshaping modern agriculture. AgriTech Insights. https://agritechinsights.com/ai-in-agriculture</li>
            <li>Khan, M. A. (2024, December 2). Why regenerative agriculture matters for Pakistan's future. AgriToday Blog. https://agritoday.pk/regenerative-agriculture-pakistan</li>
            <li>International Fund for Agricultural Development. (2024, May 12). Digital tools empowering farmers across Asia [Blog post]. IFAD. https://www.ifad.org/en/blogs/digital-agriculture</li>
        </ul>
