    ...
    <div class="bg-white mt-3">
        ...
        <div class="m-2 p-2">
            <div class="support-section">
                ...
                <div class="intro-card" id="for-editors">
                    <h3>For Editors</h3>
                ...
                <div class="intro-card" id="for-societies">
                    <h3>For Societies</h3>
            ...
            <div class="support-section" id="journal-development">
            ...
            <div class="support-section" id="editorial-support-societies">
